...
def get_weather(region):
    ...
    #weather_url = "http://devapi.qweather.com/v7/weather/now?location={}&key={}".format(location_id, key)
...
def send_message(to_user, access_token, region_name, weather, temp, wind_dir, note_ch, note_en, max_temp, min_temp,
    ...
    data = {
        ...
        "url": "https://www.52miaowang.com/pybb/0524/32/html/",
        "topcolor": "#FF0000",
        "data": {
            "date": {
